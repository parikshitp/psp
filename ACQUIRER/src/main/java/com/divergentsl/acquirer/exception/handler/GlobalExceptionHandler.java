package com.divergentsl.acquirer.exception.handler;
...
import com.divergentsl.acquirer.domain.ApiSubError;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiError> handleGenericException(Locale locale, GenericException ex) {
	...
	/**
	 * Handle entity already exist exception
	 * 
	 * @param locale
	 * @param ex
	 * @return ApiError
	...
	public ResponseEntity<ApiError> handleInvalidExpiryDateException(Locale locale, InvalidExpiryDateException ex) {
		return new ResponseEntity<>(
				new ApiError(HttpStatus.EXPECTATION_FAILED,
						messageSource.getMessage(ex.getMessage(), ex.getArgs(), locale), ex),
